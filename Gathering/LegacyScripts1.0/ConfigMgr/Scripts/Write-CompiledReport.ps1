param (
    [Parameter(Mandatory=$True,HelpMessage="Enter path to created reports")]
    $Path
)

Set-Location $Path
[Threading.Thread]::CurrentThread.CurrentCulture = 'en-US'
################################# Functions uses for converting .csvs to one .xls ##########################################
#http://gallery.technet.microsoft.com/scriptcenter/7c56c444-2476-4625-b1d9-821f30280e44/
...
get-childitem ("*.csv") | Sort-Object -descending | ConvertCSV-ToExcel -output (((get-date).tostring("yyyyMMddHHmmss")))
